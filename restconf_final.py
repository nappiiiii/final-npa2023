...
def delete():
    ...
    if(resp.status_code >= 200 and resp.status_code <= 299):
        ...
        print('Error. Status Code: {}'.format(resp.status_code))
        return "Cannot deleted: Interface loopback65070115"
...
def status():
    api_url_status = "https://10.0.15.189/restconf/data/ietf-interfaces:interfaces-state/interface=Loopback65070115"
